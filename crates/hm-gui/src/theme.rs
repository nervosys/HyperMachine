...
pub fn primary_button(text: &str) -> egui::Button<'_> {
    let colors = AppColors::default();
    egui::Button::new(egui::RichText::new(text).color(Color32::WHITE)).fill(colors.primary).corner_radius(CornerRadius::same(4))
}

pub fn danger_button(text: &str) -> egui::Button<'_> {
    let colors = AppColors::default();
    egui::Button::new(egui::RichText::new(text).color(Color32::WHITE)).fill(colors.error).corner_radius(CornerRadius::same(4))
}

pub fn success_button(text: &str) -> egui::Button<'_> {
    let colors = AppColors::default();
    egui::Button::new(egui::RichText::new(text).color(Color32::WHITE)).fill(colors.success).corner_radius(CornerRadius::same(4))
}
