...
- **"You" (or "Your")** means the copyright owner or legal entity
  ...
  legal entities, the entity and all affiliates that control, are
  controlled by, or under common control with that entity are considered a
  single Contributor.

- **"Contribution"** means any original work of authorship, including any
  modifications or additions to an existing work, that is intentionally
  submitted by You to the Project for inclusion in, or documentation of,
  any of the products owned or managed by the Project. "Submitted" means
  any form of electronic, verbal, or written communication sent to the
  Project or its representatives, including but not limited to
...
Nervosys and to recipients of software distributed by Nervosys a perpetual,
...
## 4. Dual-License Authorization

You understand and agree that HyperMachine is dual-licensed under the GNU
Affero General Public License v3 (AGPL-3.0) and a separate Commercial
License. You expressly authorize Nervosys to distribute Your Contributions
under either or both of these licenses, including the Commercial License
that permits proprietary use without AGPL obligations.
...
- **(a)** You are legally entitled to grant the above licenses. If Your
  employer(s) have rights to intellectual property that You create, You
  ...
  Your Contributions, or that Your employer has executed a separate
  Corporate CLA with Nervosys.
...
You agree to notify Nervosys of any facts or circumstances of which You
become aware that would make these representations inaccurate in any
respect.

## 9. Agreement

By submitting a pull request or other Contribution to HyperMachine, You
indicate Your acceptance of this Contributor License Agreement. All
contributors are required to sign this CLA before their contributions can
be merged.

---

**How to sign:** When you open your first pull request, the CLA bot will
automatically ask you to sign this agreement. You only need to sign once.
